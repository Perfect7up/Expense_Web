...
const FeaturesSection = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        'Pay with an Expense App corporate card and capture transactions in expense reports automatically.',
    ...
    },
    {
      ...
      title: 'Integrations',
      description:
        'Integrates with Quickbooks, NetSuite, Sage Intacct, Xero, Workday, Gusto, and 45+ more.',
