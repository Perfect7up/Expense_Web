...
const Footer = () => {
  ...
  const footerColumns = {
    features: {
      title: 'Features',
      links: [
        { text: 'Expense Management', href: 'https://use.Expense App.com/expense-management', id: '1' },
        ...
        { text: 'Company Credit Card', href: 'https://use.Expense App.com/company-credit-card', id: '4'  },
        { text: 'Receipt Scanning App', href: 'https://use.Expense App.com/receipt-scanning-app', id: '5'  },
  ...
  const socialLinks = [
    ...
    { Icon: TwitterOutlined, href: 'https://www.twitter.com/Expense App', title: 'Twitter', id: '1' },
    { Icon: InstagramOutlined, href: 'http://www.instagram.com/Expense App', title: 'Instagram', id: '1' },
    { Icon: FacebookOutlined, href: 'https://www.facebook.com/Expense App', title: 'Facebook', id: '1' },
    { Icon: LinkedinOutlined, href: 'http://www.linkedin.com/company/Expense App', title: 'LinkedIn', id: '1' }
  ];
    ...
    <footer className="bg-white py-16">
      <div className="max-w-6xl mx-auto px-4">
              ...
              {column.title === 'Get Started' && (
                <>
                  ...
                  <p className="text-sm text-gray-500 mt-4">
                    Money transmission is provided by Expense App Payments LLC (NMLS ID:2017010) pursuant to its{' '}
                    <a 
        ...
        <p className="text-sm text-gray-500 mt-8 mb-8">
          The Expense App Visa® Commercial Card is issued by The Bancorp Bank, N.A. pursuant to a license from Visa U.S.A. Inc. and may not be used at all merchants that accept Visa cards. Apple® and the Apple logo® are trademarks of Apple Inc., registered in the U.S. and other countries. App Store is a service mark of Apple Inc. Google Play and the Google Play logo are trademarks of Google LLC.
        </p>
