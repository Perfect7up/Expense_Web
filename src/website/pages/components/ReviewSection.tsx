    ...
    <div className="bg-emerald-900 py-16 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex items-center justify-center gap-4 mb-12">
          <img src="/api/placeholder/32/32" alt="G2 Logo" className="w-8 h-8" />
          <div className="text-yellow-400 text-xl">{renderStars(5)}</div>
            ...
            <div className="transition-transform duration-300 ease-in-out">
              <div className="bg-white rounded-lg p-8 max-w-xl mx-auto">
                ...
                <div className="flex items-center gap-4">
                  ...
                  />
                  <h3 className="font-medium">{reviews[currentIndex].author}</h3>
                </div>
              </div>
            </div>
          </div>
