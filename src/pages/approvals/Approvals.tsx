          ...
          <table className="w-full text-sm text-left">
            <thead className="font-semibold text-gray-400 uppercase bg-black">
              <tr className="rounded-xl">
                <th scope="col" className="px-6 py-3">
                  <FaUser className="inline-block mr-1 -mt-1" />
                  Owner
                </th>
                <th scope="col" className="px-6 py-3">
            ...
            <tbody>
              <tr className="mb-5 text-white font-semibold" style={{ backgroundColor: '#282829' }}>
                ...
                <td className="px-10 py-4">Once</td>
                <td className="px-6 py-4">
              ...
              <tr className="mb-5 text-white font-semibold" style={{ backgroundColor: '#141414' }}>
                <th
                  ...
                  className="flex items-center px-6 py-7 font-medium whitespace-nowrap"
                >
                  <FaUser className="inline-block mr-3" /> Vardy{' '}
                </th>
                <td className="px-6 py-4">
                  <span
                    className="px-10 py-2 rounded-full text-sm"
                    style={{ backgroundColor: '#73172f' }}
                  >
                    Client
                  </span>
                </td>
                <td className="px-6 py-4">€850.00</td>
                <td className="px-10 py-4">Monthly</td>
                <td className="px-6 py-4">
                  <FaEye className="inline-block mr-3" />
                  <FaCheck className="inline-block mr-3" />
                  <FaTimes className="inline-block mr-3" />
              ...
              <tr className="mb-5 text-white font-semibold" style={{ backgroundColor: '#282829' }}>
                <th
                  ...
                  className="flex items-center px-6 py-7 font-medium whitespace-nowrap"
                >
                  <FaUser className="inline-block mr-3" /> Ashlay Jack{' '}
                </th>
                <td className="px-6 py-4">
                  <span
                    className="px-7 py-2 rounded-full text-sm"
              ...
              <tr className="mb-5 text-white font-semibold" style={{ backgroundColor: '#141414' }}>
                <th
                  ...
                  className="flex items-center px-6 py-7 font-medium whitespace-nowrap"
                >
                  <FaUser className="inline-block mr-3" /> John Doe{' '}
                </th>
                <td className="px-6 py-4">
                  <span
                    className="px-10 py-2 rounded-full text-sm"
              ...
              <tr className="mb-5 text-white font-semibold" style={{ backgroundColor: '#282829' }}>
                <th
                  ...
                  className="flex items-center px-6 py-7 font-medium whitespace-nowrap"
                >
                  <FaUser className="inline-block mr-3" /> Jim Micheal{' '}
                </th>
                <td className="px-6 py-4">
                  <span
                    className="px-7 py-2 rounded-full text-sm"
