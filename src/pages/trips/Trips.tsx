      ...
      <div className="flex-grow ml-64 py-5 rounded-2xl bg-black px-10">
        <div className="flex mb-5 justify-between ">
          ...
          <div className="flex mt-5 items-center">
            <Link
              to="/trips/newtrip"
              className="bg-cyan-400 rounded-sm m-2 items-center py-1 px-4 text-sm"
            >
          ...
          <table className="w-full text-sm text-left">
            ...
            <tbody>
              <tr className="mb-5 text-white font-semibold" style={{ backgroundColor: '#282829' }}>
                <th
                  scope="row"
                  className="flex items-center px-6 py-7 font-medium whitespace-nowrap"
                >
                  <FaPlane className="inline-block mr-3" /> Capenhagen
                </th>
                <td className="px-6 py-4">Business Trip</td>
                <td className="px-6 py-4">€1000.00</td>
                <td className="px-6 py-4">20/07/2022</td>
                <td>
                  <span
                    className="px-7 py-2 rounded-full text-sm"
                    style={{ backgroundColor: '#2e1066' }}
                  >
                    Approved
                  </span>
                </td>
              ...
              <tr className="mb-5 text-white font-semibold" style={{ backgroundColor: '#141414' }}>
                <th
                  ...
                  className="flex items-center px-6 py-7 font-medium whitespace-nowrap"
                >
                  <FaPlane className="inline-block mr-3" />
                  London
                </th>
                <td className="px-6 py-4">Client Pitch</td>
                <td className="px-6 py-4">€850.00</td>
                <td className="px-6 py-4">4/07/2022</td>
                <td>
                  <span
                    className="px-8 py-2 rounded-full text-sm"
                    style={{ backgroundColor: '#8c2042' }}
                  >
                    Pending
                  </span>
                </td>
              ...
              <tr className="mb-5 text-white font-semibold" style={{ backgroundColor: '#282829' }}>
                ...
                <td className="px-6 py-4">Client Pitch</td>
                <td className="px-6 py-4">€1500.00</td>
                <td className="px-6 py-4">3/07/2022</td>
                <td>
                  <span
                    className="px-7 py-2 rounded-full text-sm"
                    style={{ backgroundColor: '#2e1066' }}
              ...
              <tr className="mb-5 text-white font-semibold" style={{ backgroundColor: '#141414' }}>
                ...
                <td className="px-6 py-4">Conference</td>
                <td className="px-6 py-4">€2000.00</td>
                <td className="px-6 py-4">29/06/2022</td>
                <td>
                  <span
                    className="px-7 py-2 rounded-full text-sm"
                    style={{ backgroundColor: '#2e1066' }}
              ...
              <tr className="mb-5 text-white font-semibold" style={{ backgroundColor: '#141414' }}>
                ...
                <td className="px-6 py-4">Business Trip</td>
                <td className="px-6 py-4">€980.00</td>
                <td className="px-6 py-4">29/06/2022</td>
                <td>
                  <span
                    className="px-3 py-2 rounded-full text-sm"
                    style={{ backgroundColor: '#7d1420' }}
                  >
                    Not Approved
                  </span>
                </td>
